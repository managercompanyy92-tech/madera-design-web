...
function renderHome() {
 ...
 <div class="hero-photo">
  ...
  <p class="highlights__text">
    ...
    градиенты создают ощущение премиальности.

    Интерфейс, который сразу транслирует статус и вкус.
  </p>

  <!-- Блок "От вдохновения..." в красивой рамке -->
  ...
  <div class="highlights__item">
    <div class="highlights__title">
      <p class="highlights__text">
        Локальный бренд, локальное производство…
      </p>
    </div>
  </div>
</section>
