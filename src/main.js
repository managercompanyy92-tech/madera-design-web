...
• Корпус — ЛДСП российских производителей.

• Фасады — ЛДСП или турецкий МДФ, в зависимости от выбранного тарифа.

• Фурнитура — Blum или качественные проверенные аналоги: направляющие, петли, механизмы плавного закрывания.


Мы подбираем материалы так, чтобы сочетать долговечность, эстетику и оптимальную стоимость.          </p>
        </article>

        <article class="highlights__item">
          <h2 class="highlights__title">Сроки и этапы</h2>
          <p class="highlights__text">
            Сроки зависят от объёма проекта и рассчитываются в рабочих днях (Пн–Пт). Отсчёт начинается после утверждения дизайн-проекта и 100% оплаты.


Корпусная мебель (кухни, шкафы, гардеробные)


• 3–6 погонных метров — около 15 рабочих дней

• 6–9 погонных метров — около 20 рабочих дней

• 9–12 погонных метров — около 25 рабочих дней


Комплексные проекты (квартиры целиком)
...
• 130+ м² — рассчитываем индивидуально.


Рабочие процессы выстроены так, чтобы вы получали готовую мебель в прогнозируемые сроки без переносов и задержек.


Напишите примерные размеры или объём вашего проекта — мы рассчитаем ориентировочную дату готовности именно под ваш случай.          </p>
        </article>

        <article class="highlights__item">
          <h2 class="highlights__title">Цена и прозрачность</h2>
          <p class="highlights__text">
            Стоимость рассчитывается честно и заранее — без скрытых доплат.

• Стандарт: 4000 сомони за погонный метр (ЛДСП фасады).

• Премиум: 5000 сомони за погонный метр (МДФ фасады). Минимальный объём — 3 погонных метра.
...
<div class="order-info__next">
  <div class="order-info__next-text">
    <strong>Частые вопросы (FAQ):</strong><br>

    <strong>— Сколько стоит метр кухни или шкафа?</strong><br>
    Мы работаем в двух категориях: Стандарт — ≈ 4000 сомони за пог. метр, Премиум — ≈ 5000 сомони за пог. метр. Итоговая стоимость зависит от стиля, фасадов, фурнитуры и наполнения.<br><br>

    <strong>— Сколько примерно будет стоить мой проект?</strong><br>
    Стоимость считаем по длине мебели: длина в пог. метрах × 4000 (стандарт) или × 5000 (премиум). Минимальный заказ — 3 погонных метра. Например, кухня 4,5 м: ≈ 18 000 сомони (Стандарт) или ≈ 22 500 сомони (Премиум).<br><br>

    <strong>— Можно ли уложиться в конкретный бюджет?</strong><br>
    Да, можем оптимизировать проект: упростить фасады, подобрать фурнитуру, убрать лишние механизмы и скорректировать наполнение. При этом мы не работаем с откровенно дешёвыми и ненадёжными материалами.<br><br>

    <strong>— За сколько дней будет готов заказ?</strong><br>
    Срок зависит от объёма: 3–12 пог. м — в среднем 15–25 рабочих дней, мебель для квартиры площадью до 130 м² — примерно 30–50 рабочих дней. Возможность ускорить производство уточняется при заказе.<br><br>

    <strong>— Из чего вы делаете мебель и чем отличается премиум?</strong><br>
    Используем ЛДСП и МДФ, качественную фурнитуру с доводчиками и стойкие фасады. Премиум — это расширенные возможности дизайна, более надёжные механизмы и улучшенная эстетика.<br><br>

    <strong>— Есть ли гарантия и сервис?</strong><br>
    Да, гарантия 12 месяцев на продукцию Madera Design, выезд мастера при необходимости и сервисная поддержка после истечения гарантии.<br><br>

    <strong>— Поможете с дизайном и можете ли работать по моему эскизу?</strong><br>
    Да, помогаем с планировкой и стилем, можем сделать мебель «как на фото» или адаптировать ваш дизайн под материалы и фурнитуру Madera Design.
  </div>
</div>
    </section>
  `;
