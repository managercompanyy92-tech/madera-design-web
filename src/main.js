...
function renderHome() {
 ...
 <div class="hero-photo">
  ...
  <p class="highlights__text">
    Фирменная палитра: глубокий чёрный, акценты тёплого золота и мягкие
    градиенты создают ощущение премиальности. Интерфейс, который сразу
    транслирует статус и вкус.
  </p>

  <!-- Карточка "От вдохновения..." -->
  <div class="hero-card inspiration-card">
    <p>
  ...
  <!-- Карточка "Локальный бренд..." -->
  <div class="hero-card inspiration-card">
    <p>
      Локальный бренд, локальное производство и глубокое понимание
      особенностей квартир и запросов клиентов Душанбе.
    </p>
  </div>
