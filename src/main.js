...
<div class="order-info__card">
  ...
  <h2 class="order-info__title">Ответы на популярные вопросы</h2>

  <ul class="order-info__list">
    <li><strong>Можно ли заказать меньше 3 пог. метров?</strong><br>
    Обычно нет, так как это нерентабельно. Но можно обсудить комбинированный проект.</li>

    <li><strong>Делаете ли вы выезд на замер?</strong><br>
    Да, после предварительного расчёта и согласия клиента.</li>

    <li><strong>Можно ли принести свой дизайн?</strong><br>
    Да, адаптируем проект под материалы и фурнитуру Madera Design.</li>
  </ul>
</div>
    </section>
  `;
