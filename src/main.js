        ...
        <div class="order-info">
          <div class="order-info__card">
            ...
            <ul class="order-info__list">
              <li>Прозрачные тарифы: 2800 / 3800 сомони за погонный метр без скрытых доплат.</li>
    ...
    <section class="page page--more">
      ...
      <section class="highlights">
        ...
        <article class="highlights__item">
          ...
          <p class="highlights__text">
            Базовые тарифы: около 2800 сомони за погонный метр для ЛДСП фасадов (Стандарт)
            и 3800 сомони для МДФ фасадов (Премиум). Минимальный объём — 3 погонных метра.
