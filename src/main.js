...
function renderProfile() {
  return `
<style>
  /* ====== ПРОФИЛЬ / ЛИЧНЫЙ КАБИНЕТ MADERA DESIGN ====== */
  ...
  .profile-card {
    ...
    background: radial-gradient(circle at top left, rgba(255, 153, 0, 0.12), transparent 55%),
                radial-gradient(circle at bottom right, rgba(0, 0, 0, 0.9), #000000);
    padding: 18px 18px 20px;
    box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.7), 0 24px 60px rgba(0, 0, 0, 0.85);
  }

  .profile-card--accent {
    border-color: rgba(255, 180, 60, 0.9);
    background: radial-gradient(circle at top left, rgba(255, 191, 73, 0.18), transparent 55%),
                radial-gradient(circle at bottom right, rgba(10, 10, 10, 0.95), #050505);
  }
  ...
  .profile-auth {
    display: none; /* по умолчанию скрыто, включаем через JS при отсутствии аккаунта */
  }
  ...
  .profile-auth__caption {
    font-size: 11px;
    color: rgba(255, 255, 255, 0.55);
  }

  /* ====== ФОРМЫ ПРОФИЛЯ / ПАРТНЁРСТВО ====== */
  ...
  .profile-partner__list li + li {
    margin-top: 3px;
  }

  .profile-partner__notice {
    display: none;
    margin-top: 8px;
    font-size: 11px;
    color: #8cff9a;
  ...
  .profile-orders__item strong {
    color: #ffffff;
  }

  .profile-orders__status-label {
    font-weight: 600;
  }

  .profile-orders__hint {
    font-size: 11px;
    color: rgba(255, 255, 255, 0.6);
    margin-top: 8px;
  }
...
<section class="page page--profile">
  ...
  <p class="page__subtitle">
    Ваш персональный сервис Madera Design: статусы заказов, профиль клиента, партнёрская программа и история взаимодействия с нашей командой.
  </p>

  <div class="profile-layout">
    <!-- Левая колонка: авторизация + профиль + партнёрская программа -->
    <div class="profile-layout__left">

      <!-- БЛОК АВТОРИЗАЦИИ / РЕГИСТРАЦИИ -->
      <div class="profile-card profile-card--accent profile-auth" id="profile-auth">
        <div class="profile-card__title">Создайте аккаунт Madera Design</div>
        <div class="profile-card__subtitle">
          Лёгкая регистрация по номеру WhatsApp. После входа откроются статусы заказов, бонусы и партнёрская программа.
        </div>
        ...
        <div class="profile-auth__forms">
          ...
          <form class="profile-auth__panel" data-auth-panel="register" data-auth-register>
            ...
            <div class="profile-auth__hint">
              Создавая аккаунт, вы подтверждаете согласие с условиями сервиса и обработкой персональных данных.
            </div>
          </form>
          ...
          <form class="profile-auth__panel is-hidden" data-auth-panel="login" data-auth-login>
            ...
            <div class="profile-auth__hint">
              Если вы ещё не регистрировались, сначала создайте аккаунт — это займёт меньше минуты.
            </div>
          </form>
        </div>

        <div class="profile-auth__divider"></div>
        <div class="profile-auth__caption">
          После регистрации вы сможете отслеживать заказы, получать промокоды и управлять партнёрской программой.
        </div>
      </div>

      <!-- ОСНОВНОЙ КОНТЕНТ ПРОФИЛЯ (открывается после авторизации) -->
      <div class="profile-card profile-card--accent" id="profile-main" style="display:none;">
        <div class="profile-card__title">Профиль клиента</div>
        <div class="profile-card__subtitle">
          Базовые данные, чтобы менеджеру и системе было проще подбирать решения, материалы и вести коммуникацию.
        </div>
        ...
        <div class="profile-form-grid">
          <div class="profile-form__row">
            ...
            <input
              ...
              placeholder="(будет подтягиваться из заявок)"
              readonly
            />
          </div>
        ...
        <div class="profile-form__footer">
          В дальнейшем вы сможете самостоятельно обновлять свои данные и предпочтения, а система будет предлагать идеи под ваш стиль и бюджет.
        </div>
      ...
      <div class="profile-card">
        ...
        <ul class="profile-partner__list">
        ...
        <p class="profile-card__muted">
          Дизайнеры, блогеры, мастера, прорабы, владельцы студий, риелторы и любой человек, который рекомендует наши услуги реальным клиентам.
        </p>
        ...
        <form class="profile-form-grid" data-partner-form>
          <div class="profile-form__row">
            <label>Имя</label>
            <input
              type="text"
          ...
          <div class="profile-form__row">
            ...
            <select class="profile-form__select" name="partner-role" required>
              <option value="">Выберите вариант</option>
              <option value="designer">Дизайнер интерьеров</option>
              <option value="blogger">Блогер / инфлюенсер</option>
              <option value="master">Мастер / прораб</option>
              <option value="studio">Владелец студии / салона</option>
              <option value="other">Другое</option>
            </select>
          </div>

          <div class="profile-form__row">
            <label>Ссылка на профиль (Instagram и т. д.)</label>
            <input
              type="text"
              class="profile-form__input"
              name="partner-link"
          ...
          <div class="profile-form__row">
            <label>Кратко об аудитории</label>
            <textarea
              class="profile-form__textarea"
          ...
          <div class="profile-partner__notice" data-partner-notice>
            Заявка отправлена. Менеджер свяжется с вами для подтверждения и выдачи промокода.
          </div>
        </form>
      </div>
    ...
    <!-- Правая колонка: мои заказы и статусы -->
    <div class="profile-layout__right">

      <!-- МОИ ЗАКАЗЫ -->
      <div class="profile-card">
        <div class="profile-card__section-title">Мои заказы</div>
        <div class="profile-card__title">Статусы и этапы ваших проектов</div>
        <div class="profile-card__subtitle">
          Здесь будет список всех ваших заказов в Madera Design с этапами и статусами в реальном времени.
        </div>

        <div class="profile-orders__items">
          <div class="profile-orders__item">
            • <strong>Заказ №MD-001</strong> — кухня 4,5 м, тариф «Премиум», статус:
            <span class="profile-orders__status-label">в работе</span>.
          </div>
          <div class="profile-orders__item">
            • <strong>Заказ №MD-002</strong> — гардеробная 3 м, тариф «Стандарт», статус:
            <span class="profile-orders__status-label">ожидает замера</span>.
          </div>
        </div>

        <div class="profile-orders__hint">
          В реальной версии здесь будет подключена база заказов, точные даты, сумма, этапы («Замер», «Дизайн», «Производство», «Монтаж») и быстрый переход в чат с менеджером по конкретному проекту.
        </div>
      </div>

      <!-- СТАТУС ЗАКАЗА: ОБЪЯСНЕНИЕ -->
      <div class="profile-card">
        <div class="profile-card__section-title">Статус заказа</div>
        <div class="profile-card__title">Как отслеживать свой заказ</div>
        <div class="profile-card__subtitle">
          Статус заказа показывает текущий этап вашего проекта в системе Madera Design — от заявки и дизайна до производства, монтажа и сдачи работы.
        </div>

        <ul class="profile-status__list">
          <li>«Заявка получена» — мы приняли запрос и формируем бриф.</li>
          <li>«Замер» — подтверждаем дату, выезжает мастер.</li>
          <li>«Дизайн-проект в разработке» — готовим планировку и визуализации.</li>
          <li>«Дизайн-проект согласован» — вы утверждаете решение.</li>
          <li>«Счёт выставлен / Ожидание оплаты» — сформирован счёт.</li>
          <li>«Оплачено / Запуск в производство» — заказ уходит в работу на фабрику.</li>
          <li>«В производстве» — изготавливаются модули, фасады, фурнитура.</li>
          <li>«Готово к монтажу» — комплект подготовлен к выезду.</li>
          <li>«В монтаже» — идёт установка и финальная подстройка.</li>
          <li>«Завершено / Сдано» — проект передан вам и закрыт.</li>
        </ul>
        ...
        <div class="profile-status__badge">
          ...
          После подтверждения платежа статус автоматически меняется на «Оплачено / Запуск в производство».
        </div>
      </div>
...
<script>
  function initMaderaProfile() {
    const authBlock = document.getElementById("profile-auth");
    const mainBlock = document.getElementById("profile-main");
    if (!authBlock || !mainBlock) return;
    ...
    function fillProfileFromStorage() {
      ...
      if (nameOutput) nameOutput.value = name || "(будет подтягиваться из заявок)";
      if (phoneOutput) phoneOutput.value = phone || "(будет подтягиваться из заявок)";
    }
    ...
    // табы авторизации
    const tabButtons = authBlock.querySelectorAll("[data-auth-tab]");
    const tabPanels = authBlock.querySelectorAll("[data-auth-panel]");
    ...
    tabButtons.forEach((btn) => {
      btn.addEventListener("click", () => {
        ...
        tabPanels.forEach((panel) => {
          const isThis = panel.dataset.authPanel === mode;
          panel.classList.toggle("is-hidden", !isThis);
        });
      });
    });

    // регистрация
    const regForm = authBlock.querySelector("[data-auth-register]");
    if (regForm) {
    ...
    // вход
    const loginForm = authBlock.querySelector("[data-auth-login]");
    if (loginForm) {
    ...
    if (partnerForm) {
      partnerForm.addEventListener("submit", (event) => {
        event.preventDefault();
        const notice = partnerForm.querySelector("[data-partner-notice]");
        if (notice) {
          notice.style.display = "block";
          notice.textContent = "Заявка отправлена. Менеджер свяжется с вами для подтверждения и выдачи промокода.";
        }
        partnerForm.reset();
      });
    }
